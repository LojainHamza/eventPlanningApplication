...
class MyAppStyles {
  ...
  static TextStyle bold14Black = GoogleFonts.inter(
      fontWeight: FontWeight.bold, fontSize: 14, color: MyAppColors.blackColor);
  ...
  static TextStyle bold20White = GoogleFonts.inter(
      fontWeight: FontWeight.bold, fontSize: 20, color: MyAppColors.whiteColor);
  ...
  static TextStyle regular20White = GoogleFonts.inter(
      fontWeight: FontWeight.w400, fontSize: 20, color: MyAppColors.whiteColor);
