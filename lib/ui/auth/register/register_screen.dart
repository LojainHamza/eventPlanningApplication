...
import 'package:event_planning_app/ui/auth/register/register_screen_view_model.dart';
...
class _RegisterScreenState extends State<RegisterScreen> implements RegisterNavigator{
  ...
  void showMyMessage(String message) {
    DialogUtils.showMessage(context: context, message: message,posActionName: AppLocalizations.of(context)!.ok);
  }
